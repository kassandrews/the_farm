...
/** A tool the player has selected; the action button applies it (DESIGN
 *  §vertical slice: dig, place two tile types, plant, water, harvest). */
export type Tool = "dig" | "plank" | "plant" | "water";
