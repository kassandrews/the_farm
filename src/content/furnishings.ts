  ...
  doublebed: {
    ...
    s: {
      rows: [
        ...
        ".kcccccccccccccccccccccccccccccccccccccccccccck.",
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ...Array<string>(6).fill(".kppppppppppppppppppppCCCCppppppppppppppppppppk."),
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ...Array<string>(20).fill(".kCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCk."),
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ".kssssssssssssssssssssssssssssssssssssssssssssk.",
        ".kcccccccccccccccccccccccccccccccccccccccccccck.",
        ".kcccccccccccccccccccccccccccccccccccccccccccck.",
    ...
    // THE TURNED VIEW, which a 2×2 never needed. At 3×2 the east footprint is
    // 2×3, so falling back to the front view is the wrong SHAPE and the size
    // contract says so in four failures. Two tiles across, three deep, head at
    // the far end — the single bed's front view scaled up rather than a new idea.
    e: {
      rows: [
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ".kttttttttttttttttttttttttttttk.",
        ...
        ".kcccccccccccccccccccccccccccck.",
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ".kpppppppppppppCCpppppppppppppk.",
        ".kpppppppppppppCCpppppppppppppk.",
        ".kpppppppppppppCCpppppppppppppk.",
        ".kpppppppppppppCCpppppppppppppk.",
        ".kpppppppppppppCCpppppppppppppk.",
  ...
  bed: {
    ...
    e: {
      rows: [
        ...
        "................................",
        ".kkkkkkkkkkkkkkkkkkkkkkkkkkkkkk.",
        ".kcckpppppppkCCCCCCCCCCCCCCCk...",
        ".kcckpppppppkCCCCCCCCCCCCCCCk...",
        ".kcckgggggggkCCCCCCCCCCCCCCCk...",
        ".kcckoooooookCCCCCCCCCCCCCCCk...",
        ".kcckoooooookCCCCCCCCCCCCCCCk...",
        ".kcckoooooookCCCCCCCCCCCCCCCk...",
        ".kcckoooooookCCCCCCCCCCCCCCCk...",
        ".kcckoooooookCCCCCCCCCCCCCCCk...",
