...
export const NAMES: Record<AdultForm, string[]> = {
  ...
  gremlin: ["Nub", "Snag", "Tick", "Grit", "Scuff", "Bodge", "Rasp"],

  // Fusty, over-formal, and old — the register of somebody who has published.
  // Corrigal and Margfrom are in here because they were the museum curator and
  // the starter resident before this pass, and a retired name is still a good
  // name; they can walk into town later as somebody else.
  scholar: ["Winifred", "Prudence", "Ambrose", "Corrigal", "Margfrom", "Hesketh", "Fenwick"],
  ...
  dog: ["Pesto", "Biscuit", "Waffle", "Gnocchi", "Pip", "Rummage", "Barnaby"],

  // Stage names. Grand, vowel-heavy, and a little too much — the kind of name
  // you give yourself. Ouestrine kept her spot here for that reason.
  blob: ["Aurelio", "Thessaly", "Ouestrine", "Vandemar", "Seraphine", "Bellamy"],
